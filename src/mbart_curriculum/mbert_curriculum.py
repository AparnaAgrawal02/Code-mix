...
model =  BartForConditionalGeneration.from_pretrained('/ssd_scratch/cvit/aparna/mbert-synthetic').to(device)

#model = BartForConditionalGeneration.from_pretrained("").to(device)
...
training_args = Seq2SeqTrainingArguments(
  output_dir = "/ssd_scratch/cvit/aparna/mbert-curriculum-codemixed",
  log_level = "error",
  num_train_epochs = 10,
  learning_rate = 5e-4,
...
#save model
trainer.save_model("/ssd_scratch/cvit/aparna/mbert_curriculum")
