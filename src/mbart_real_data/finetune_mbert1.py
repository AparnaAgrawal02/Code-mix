...
model = BartForConditionalGeneration.from_pretrained("mbert-codemixed/checkpoint-2000").to(device)
...
training_args = Seq2SeqTrainingArguments(
  output_dir = "/ssd_scratch/cvit/aparna/mbert-codemixed",
  log_level = "error",
  num_train_epochs = 10,
  learning_rate = 5e-4,
...
#save model
trainer.save_model("/ssd_scratch/cvit/aparna/mbert")
